...
class MC extends Vtiger_CRMEntity {
        var $table_name = 'vtiger_mc';
        var $table_index= 'mcid';

        var $customFieldTable = Array('vtiger_mccf', 'mcid');

        var $tab_name = Array('vtiger_crmentity', 'vtiger_mc', 'vtiger_mccf');
