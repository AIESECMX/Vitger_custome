...
class LC extends Vtiger_CRMEntity {
        var $table_name = 'vtiger_lc';
        var $table_index= 'lcid';

        var $customFieldTable = Array('vtiger_lccf', 'lcid');

        var $tab_name = Array('vtiger_crmentity', 'vtiger_lc', 'vtiger_lccf');
